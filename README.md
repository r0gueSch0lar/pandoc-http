RESTful HTTP API for Pandoc forked from [dwolters/pandoc-http](https://github.com/dwolters/pandoc-http) because I couldnt be bothered trying to get an overly complicated overleaf deployment up (yet to understand why theyre bothering with a mongodb replicaset in docker rather than just deploying with k8s)

## Updated

### Added PANDOC_PORT env and arg to Dockerfiles.

### Created compose file

### Modified server.js to use PANDOC_PORT env variable if present
